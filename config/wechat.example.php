...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'XXXXXXXX'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'XXXXXXXX'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'XXXX'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', ''),                    // EncodingAESKey
    'base_url'=> env('WECHAT_BASE_URL', 'http://bdyk.zzufor.com/'),
    /**
     * 日志配置
     *
     * level: 日志级别，可选为：
