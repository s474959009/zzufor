   ...
   <!-- <div class="weui_cells_title">每位同学只能绑定自己的学号</div> -->
    ...
    <div class="weui_cells_tips">输入需要绑定的学号密码即可更换已绑定的学号</div>
       ...
       var post = function(){
        $.ajax({
            ...
            success:function(data){
                    if(data == 'success'){ 
                         window.location.href = 'http://bdyk.zzufor.com/message/edit/success';
                    } else if (data == 'warn' || data == ""){ 
                         window.location.href = 'http://bdyk.zzufor.com/message/edit/warn';
                    } else                                  
                         tooltips(data);
                    },
            error:function(xhr){
