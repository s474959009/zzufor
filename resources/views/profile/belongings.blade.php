    ...
    <div id="actionSheet_wrap">
        ...
        <div class="weui_actionsheet" id="weui_actionsheet">
            <div class="weui_actionsheet_menu">
                <div class="weui_actionsheet_cell"><a href="tel:18838988879">已被认领</a></div>
                <div class="weui_actionsheet_cell"><a href="sms:18838988879">删除物品</a></div>
            </div>
            <div class="weui_actionsheet_action">
                <div class="weui_actionsheet_cell" id="actionsheet_cancel">物品管理</div>
            </div>
        </div>
    </div>
@stop
